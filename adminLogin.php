...
<section class="my-sec">
    ...
    <div class="my-container">
        <div class="my-taps">
            <button class="my-tap-btn my-active" id="login">Admin</button>
            <div class="my-line" ></div>
        </div>
        <div class="my-form">
          <div class="my-login-form">
             <h1>Admin login</h1>
             <form method="POST" action="src/authloginadmin.php" >
                 <div class="my-form-group">
                    <label>Username</label>
                    <input type="text" class="my-form-control" name="username" required>
                 </div>
                 <div class="my-form-group">
                     <label>Password</label>
                     <input type="password" class="my-form-control" name="password" required>
                 </div>
                 <center><p>Not a admin? <a href="login.php">Click here!</a></p></center>
                 <div class="my-form-group">
